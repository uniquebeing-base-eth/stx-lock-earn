...
/**
 * Toast component
 * A notification system built on Radix UI Toast primitives.
 * Used to show temporary feedback messages like success, error, or info updates.
 * Supports swipe-to-dismiss, animations, actions, and variants (default / destructive).
 */
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.destructive]:border-muted/40 group-[.destructive]:hover:bg-destructive",
