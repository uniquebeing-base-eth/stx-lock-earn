...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  if (key in payload && typeof payload[key as keyof typeof payload] === "string") {
    ...
    payloadObj &&
    key in payloadObj &&
    typeof payloadObj[key as keyof typeof payloadObj] === "string"
  ) {
    configKey = payloadObj[key as keyof typeof payloadObj] as string;
  }

  return config[configKey] || config[key as keyof typeof config];
}
